                                    ...
                                    <div className="col-lg-6 mt-4 mt-lg-0">
                                        <div className="about-content">
                                            ...
                                            <p className="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                                ...
                                                world.<br/>
                                                We identify real challenges, bridge gaps, and deliver solutions that
                                                work for
                                                you.<br/>
                                                Solutions that simplify complexity, increase visibility, and drive
                                                meaningful
                                                results.<br/>
                                            ...
                                            <div className="about-icon-items">
                                                <div className="icon-items wow fadeInUp" data-wow-delay=".7s">
                                                    <div className="icon">
                                                        <img src="/assets/img/about/icon-4.svg"
                                                    ...
                                                    <div className="content">
                                                        ...
                                                        <p>
                                                            ...
                                                            We craft systems that solve problems — not just automate
                                                            tasks.
                                                        </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="icon-items wow fadeInUp" data-wow-delay=".9s">
                                                    <div className="icon">
                                                        <img src="/assets/img/about/icon-5.svg"
                                                             alt="Mission and Vision Icon"/>
                                                    </div>
                                                    <div className="content">
